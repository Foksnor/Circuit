        ...
        private void Initialize()
        {
            ...
            sizeIncreaseSlider =
                new FluidRangeSlider(0, 128)
                    ...
                    .SetSnapValues(0f, 4f, 8f, 12f, 16f, 20f, 24f, 32f, 40f, 48f, 56, 64f, 72f, 80f, 88f, 96f, 104f, 112f, 120f, 128f)
                    .SetSnapDistanceForSnapValues(1f)
                    .SetAutoResetValue(0)
                    .SetSliderValue(0);
            ...
            snapToIntervalCheckbox =
                FluidToggleCheckbox.Get()
                    ...
                    .SetOnValueChanged(evt =>
                    {
                        ...
                        sizeIncreaseSlider.SnapToInterval(evt.newValue);
                        sizeDecreaseSlider.SnapToInterval(evt.newValue);
            ...
            snapToValuesCheckbox =
                FluidToggleCheckbox.Get()
                    ...
                    .SetOnValueChanged(evt =>
                    {
                        ...
                        sizeIncreaseSlider.SnapToValues(evt.newValue);
                        sizeDecreaseSlider.SnapToValues(evt.newValue);
                    });

            sizeIncreaseSlider.SnapToValues(snapToValuesCheckbox.isOn);
            sizeDecreaseSlider.SnapToValues(snapToValuesCheckbox.isOn);
