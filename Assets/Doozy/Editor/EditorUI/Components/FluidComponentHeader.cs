...
namespace Doozy.Editor.EditorUI.Components
{
    public class FluidComponentHeader : PoolableElement<FluidComponentHeader>
    {
        ...
        public FluidComponentHeader AddApiButton(string url = "https://api.doozyui.com/")
        {
        ...
        public FluidComponentHeader AddManualButton(string url = "https://docs.doozyui.com/")
        {
            if (EditorApplication.isPlayingOrWillChangePlaymode) return this; //do not add Manual button in play mode
        ...
        public FluidComponentHeader AddYouTubeButton(string url = "https://youtube.doozyui.com/")
        {
