...
namespace Doozy.Editor.Mody.Editors.Modules
{
    ...
    public sealed class AudioSourceModuleEditor : ModyModuleEditor<AudioSourceModule>
    {
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader
                .SetComponentNameText(AudioSourceModule.DEFAULT_MODULE_NAME)
                .SetSecondaryIcon(EditorSpriteSheets.EditorUI.Icons.Sound)
                .AddManualButton()
                .AddApiButton("https://api.doozyui.com/api/Doozy.Runtime.Mody.Modules.AudioSourceModule.html")
                .AddYouTubeButton();
        }
