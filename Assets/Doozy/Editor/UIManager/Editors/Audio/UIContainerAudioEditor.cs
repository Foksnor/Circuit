...
namespace Doozy.Editor.UIManager.Editors.Audio
{
    ...
    public class UIContainerAudioEditor : BaseTargetComponentAnimatorEditor
    {
        ...
        protected override void OnDestroy()
        {
            ...
            showAudioClipFluidField?.Dispose();
            hideAudioClipFluidField?.Dispose();
        }
        ...
        protected override void InitializeEditor()
        {
            ...
            showAudioClipFluidField.fieldLabel.SetStyleWidth(k_FieldLabelWidth);
            hideAudioClipFluidField.fieldLabel.SetStyleWidth(k_FieldLabelWidth);
        }
