...
namespace Doozy.Editor.UIManager.Editors.Audio
{
    ...
    public class UISelectableAudioEditor : BaseTargetComponentAnimatorEditor
    {
        ...
        protected override void OnDestroy()
        {
            ...
            normalAudioClipFluidField?.Dispose();
            highlightedAudioClipFluidField?.Dispose();
            pressedAudioClipFluidField?.Dispose();
            selectedAudioClipFluidField?.Dispose();
            disabledAudioClipFluidField?.Dispose();
        }
        ...
        protected override void InitializeEditor()
        {
            ...
            normalAudioClipFluidField.fieldLabel.SetStyleWidth(k_FieldLabelWidth);
            highlightedAudioClipFluidField.fieldLabel.SetStyleWidth(k_FieldLabelWidth);
            pressedAudioClipFluidField.fieldLabel.SetStyleWidth(k_FieldLabelWidth);
            selectedAudioClipFluidField.fieldLabel.SetStyleWidth(k_FieldLabelWidth);
            disabledAudioClipFluidField.fieldLabel.SetStyleWidth(k_FieldLabelWidth);
        }
