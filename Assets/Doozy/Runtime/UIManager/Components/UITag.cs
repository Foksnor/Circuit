...
namespace Doozy.Runtime.UIManager.Components
{
    ...
    [AddComponentMenu("Doozy/UI/Components/UITag")]
    public partial class UITag : MonoBehaviour
    {
          #if UNITY_EDITOR
        [UnityEditor.MenuItem("GameObject/Doozy/UI/Components/UITag", false, 8)]
        private static void CreateComponent(UnityEditor.MenuCommand menuCommand)
        {
            GameObjectUtils.AddToScene<UITag>("UITag", false, true);
        }
        #endif
