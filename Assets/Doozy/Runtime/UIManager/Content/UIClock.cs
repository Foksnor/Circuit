...
namespace Doozy.Runtime.UIManager.Content
{
    ...
    /// </summary>
    [AddComponentMenu("Doozy/UI/DateTime/UI Clock")]
    public class UIClock : DateTimeComponent
    {
        #if UNITY_EDITOR
        [UnityEditor.MenuItem("GameObject/Doozy/UI/DateTime/UI Clock", false, 8)]
        private static void CreateComponent(UnityEditor.MenuCommand menuCommand)
        {
            GameObjectUtils.AddToScene<UIClock>("UIClock", false, true);
        }
        #endif
