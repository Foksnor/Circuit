...
namespace Doozy.Runtime.UIManager.Listeners
{
    ...
    /// </summary>
    [AddComponentMenu("Doozy/Signals/Listeners/Vector3 Signal Listener")]
    public class Vector3SignalListener : SignalListener
    {
        #if UNITY_EDITOR
        [UnityEditor.MenuItem("GameObject/Doozy/Signals/Listeners/Vector3 Signal Listener", false, 8)]
