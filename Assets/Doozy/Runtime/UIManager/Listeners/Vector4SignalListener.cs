...
namespace Doozy.Runtime.UIManager.Listeners
{
    ...
    /// </summary>
    [AddComponentMenu("Doozy/Signals/Listeners/Vector4 Signal Listener")]
    public class Vector4SignalListener : SignalListener
    {
        #if UNITY_EDITOR
        [UnityEditor.MenuItem("GameObject/Doozy/Signals/Listeners/Vector4 Signal Listener", false, 8)]
