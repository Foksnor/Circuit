...
namespace Doozy.Runtime.UIManager.Listeners
{
    ...
    /// </summary>
    [AddComponentMenu("Doozy/UI/Components/Listeners/UIToggle Listener")]
    public class UIToggleListener : BaseListener, IUseMultiplayerInfo
    {
        #if UNITY_EDITOR
        [UnityEditor.MenuItem("GameObject/Doozy/UI/Components/Listeners/UIToggle Listener", false, 8)]
