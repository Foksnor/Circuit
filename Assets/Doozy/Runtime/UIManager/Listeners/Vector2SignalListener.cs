...
namespace Doozy.Runtime.UIManager.Listeners
{
    ...
    /// </summary>
    [AddComponentMenu("Doozy/Signals/Listeners/Vector2 Signal Listener")]
    public class Vector2SignalListener : SignalListener
    {
        #if UNITY_EDITOR
        [UnityEditor.MenuItem("GameObject/Doozy/Signals/Listeners/Vector2 Signal Listener", false, 8)]
