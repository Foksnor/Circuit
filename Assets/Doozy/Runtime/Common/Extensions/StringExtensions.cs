...
namespace Doozy.Runtime.Common.Extensions
{
    ...
    {
        /// <summary> Wrap the given text in a color tag for the given color </summary>
        /// <param name="text"> Text to colorize </param>
        /// <param name="color"> Color </param>
        /// <returns> Text wrapped in a color tag </returns>
        public static string Colorize(this string text, Color color) =>
            $"<color=#{ColorUtility.ToHtmlStringRGB(color)}>{text}</color>";
        
        /// <summary> Wrap in Bold tags the given text </summary>
        /// <param name="text"> Text to wrap </param>
        /// <returns> Text wrapped in Bold tags </returns>
        public static string Bold(this string text) =>
            $"<b>{text}</b>";
        
        /// <summary> Wrap in Italic tags the given text </summary>
        /// <param name="text"> Text to wrap </param>
        /// <returns> Text wrapped in Italic tags </returns>
