...
namespace Doozy.Runtime.Colors
{
    ...
    {
        /// <summary> Set the alpha value of a Color </summary>
        /// <param name="target"> Target Color </param>
        /// <param name="alpha"> Alpha value from 0 to 1 (value is clamped) </param>
        /// <returns> A the Color with the updated alpha value </returns>
        ...
        /// <summary> Convert a HEX value to Color </summary>
        /// <param name="target"> Target Color </param>
        ...
        public static Color FromHEX(this Color target, string hex)
        {
            ...
            if (hex.Length != 6) throw new Exception("Invalid HEX string: " + hex);
        ...
        /// <summary> Get the HEX value of a Color </summary>
        /// <param name="target"> Target Color </param>
        /// <returns> HEX value </returns>
        public static string ToHEX(this Color target)
        {
            //convert color to hex
            var r = (int)(target.r * 255);
            var g = (int)(target.g * 255);
            var b = (int)(target.b * 255);
