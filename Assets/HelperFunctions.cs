...
public static class HelperFunctions
{
    ...
    public static readonly Dictionary<_CardAction, string> actionDescriptions = new()
    {
        ...
        { _CardAction.DestroyThisCard, "<style=Cost><style=Highlight>BURN</style> this card!<br>Remove this card from your deck.</style>" },
        { _CardAction.DestroyOtherCard, "<style=Cost><style=Highlight>BURN</style> {x} random card!<br>Remove that card from your deck.</style>" },
        { _CardAction.EnhanceSlotFire, "<style=Highlight>{x} Fire</style><br>Enhances a <style=Highlight>card-slot</style> with <style=Highlight>fire</style>. Cards played in this slot will use <style=Highlight>fire</style>." },
        { _CardAction.EnhanceSlotShock, "<style=Highlight>{x} Shock</style><br>Enhances a <style=Highlight>card-slot</style> with <style=Highlight>shock</style>. Cards played in this slot will use <style=Highlight>shock</style>." },
        { _CardAction.EnhanceSlotRetrigger, "<style=Highlight>{x} Echo</style><br>Enhances a <style=Highlight>card-slot</style> with <style=Highlight>echo</style>. Cards played in this slot will trigger twice." },
    ...
    private static readonly Dictionary<_CardAction, string> actionHexColors = new()
    {
        ...
        { _CardAction.DiscardThisCard, "#550000" },
        { _CardAction.DiscardOtherCard, "#550000" },
        { _CardAction.DestroyThisCard, "#550000" },
        { _CardAction.DestroyOtherCard, "#550000" },
